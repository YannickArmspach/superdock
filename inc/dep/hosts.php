...
set('SUPERDOCK', function() {
	$SUPERDOCK = [];
	$SUPERDOCK['BASENAME'] = $_ENV['SUPERDOCK_PROJECT_BASENAME'];
	...
	switch( get('deploy_env') ) {
		case "local":
			...
			$SUPERDOCK['DIST_UPLOAD'] = $_ENV['SUPERDOCK_LOCAL_DIR'] . $_ENV['SUPERDOCK_LOCAL_UPLOAD'];
		break;
		case "staging":
			$SUPERDOCK['DIST_DIR'] = $_ENV['SUPERDOCK_STAGING_DIR'];
			$SUPERDOCK['DIST_UPLOAD'] = $_ENV['SUPERDOCK_STAGING_DIR'] . $_ENV['SUPERDOCK_STAGING_UPLOAD'];
		break;
		case "preproduction":
			$SUPERDOCK['DIST_DIR'] = $_ENV['SUPERDOCK_PREPRODUCTION_DIR'];
			$SUPERDOCK['DIST_UPLOAD'] = $_ENV['SUPERDOCK_PREPRODUCTION_DIR'] . $_ENV['SUPERDOCK_PREPRODUCTION_UPLOAD'];
		break;
		case "production":
			$SUPERDOCK['DIST_DIR'] = $_ENV['SUPERDOCK_PRODUCTION_DIR'];
			$SUPERDOCK['DIST_UPLOAD'] = $_ENV['SUPERDOCK_PRODUCTION_DIR'] . $_ENV['SUPERDOCK_PRODUCTION_UPLOAD'];
		break;
	}
	return $SUPERDOCK;
} );